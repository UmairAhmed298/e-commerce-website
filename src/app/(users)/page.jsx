    ...
    <div className="w-full h-fit flex flex-col pt-22">
      <div className="flex justify-center relative w-full">
        <div className="h-83 rounded-2xl w-[98%] bg-[#d2ecf0] relative overflow-hidden">
          <Image src="/blob.png" width={250} height={100} alt="blob" />
          ...
          <p className="text-black bg-transparent absolute left-10 top-24 text-4xl">
            Find it. Buy it.
          </p>
          <p className="text-black bg-transparent absolute top-37 left-10 w-90 ">
      ...
      <div className="flex justify-center w-full">
        <div className="h-65 rounded-2xl w-[98%] bg-white mt-10">
          <div className="flex justify-between">
            <span className="font-medium text-2xl text-gray-600 p-10">
              Categories
            </span>
          ...
          >
            <div className="mt-[-45px]">
              <Image src="/left-arrow.png" width={40} height={25} alt="arrow" />
            </div>
            ...
            <div id="No-liability" className="flex flex-col items-center">
              ...
              <span className="text-center p-3 text-gray-500">
                No Liability
              </span>
            </div>
        ...
        <div className="h-83 rounded-2xl w-[47%] bg-white ">
          <div id="Iphone">
            <div className="flex flex-col gap-3">
              ...
              <span className="text-[9px] w-58 text-gray-500">
      ...
      <div className="flex justify-center w-full bg-gray-100">
        <div className="h-fit rounded-2xl w-[88%] mt-1 flex flex-col">
          ...
          <div className="flex gap-4 justify-between mt-5">
            <div
              id="item-1"
              className="w-fit h-fit bg-white p-3 shadow-2xl relative rounded-xl"
            >
              <div className="w-fit h-40 overflow-hidden">
                <Image src="/item-1.jpg" width={180} height={100} alt="" />
              </div>
            ...
            <div
              id="item-2"
              className="w-50 h-fit bg-white p-3  shadow-2xl relative rounded-xl"
            >
              <div className="w-fit h-40 overflow-hidden">
                <Image
                  src="/item-2.jpg"
            ...
            <div
              id="item-4"
              className="w-50 h-full bg-white p-3  shadow-2xl relative rounded-xl"
            >
              <div className="w-fit h-40 overflow-hidden">
                <Image
                  src="/item-4.jpg"
